...
1. 使用 Maven 或 Gradle 运行测试，以收集关于测试和覆盖率的基线数据：
   ...
   注意：因此，report.xml 和 cover .xml 文件将在 'cbt' 子文件夹中创建。 
...
1. 使用 Maven 或 Gradle 运行测试，以收集测试和覆盖率的基线数据：
   ...
   注意：因此，report.xml 和 coverage.xml 文件将在 'cbt' 子文件夹中创建。
...
有关更多详情，请查阅 https://docs.parasoft.com/display/JTEST1043/Application+Coverage
